...
public class AdminModel {
	...
	private int movie_score_people;
	...
	public int getMovie_score_people() {
		return movie_score_people;
	}
	public void setMovie_score_people(int movie_score_people) {
		this.movie_score_people = movie_score_people;
	}
}
