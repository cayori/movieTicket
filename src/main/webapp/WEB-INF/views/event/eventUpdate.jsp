...
<div id="container_admin">
	<div class="admin_grp">
		...
		<div class="admin_ct">
			...
			<form:form commandName="eventModel" action="eventUpdate.mt" enctype="multipart/form-data" method="post" name="forms" onsubmit="return validation();">
					...
					<table>
						...
						<tbody>
							<tr>
								<th scope="row">제목</th>
								<td>
									<input type="text" name="subject" value="${eventModel.subject}" class="txt w200"/>
							...
							<tr> <!-- 에디터로 바꾸어야 할 부분 -->
								...
								<td>
									<div class="textarea_grp">
										<textarea name="content">${eventModel.content}</textarea>
							...
							<tr>
								<th scope="row">시작일</th>
								<td>
									<input type="text" name="e_start_date" value="<fmt:formatDate value="${eventModel.e_start_date}" pattern="yyyy.MM.dd"/>" class="txt w200"/>예) 2016.06.14
							...
							<tr>
								<th scope="row">종료일</th>
								<td>
									<input type="text" name="e_end_date" value="<fmt:formatDate value="${eventModel.e_end_date}" pattern="yyyy.MM.dd"/>" class="txt w200"/>예) 2016.06.14
